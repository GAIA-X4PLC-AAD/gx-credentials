...
const LoginButton = () => {
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-slate-950 px-3 py-1 text-lg font-medium text-white backdrop-blur-3xl transition-colors duration-500 hover:bg-primary">
        Login
      </span>
    </Button>
  );
