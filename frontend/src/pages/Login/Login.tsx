      ...
      <HeroHighlight>
        ...
        >
          <div className="flex flex-col space-y-4">
            <p className="relative z-20 bg-gradient-to-b from-primary-foreground via-purple-400 to-primary bg-clip-text text-4xl font-bold text-transparent sm:text-7xl">
              GX Credentials
            </p>
            <SebisLogo />
          </div>
